...
from .settings_types import Pixel,Language,RGB,TTS_Voice

# SETTINGS

# STT
LANGUAGE: Language = "en"  # Language to use (Default: "en")
VOICE_ACTIVATION_KEYWORD: str = (
    "focus"  # The word to use in text to activate voice assistant. This should always be lowercase (Default: "no")
)
VOICE_ACTIVATION_CONFIRMATION: str = (
    "Yes?"  # The word the voice assistant will respond back to confirm it is listening (Default: "Yes?")
)
...
# Popups
POPUP_WINDOW_PADDING: Pixel = (
    10  # Padding from top-left of screen for popups (Default: 10)
)
...
# TTS
TTS_VOICE: TTS_Voice = (
    "en-US-EmmaMultilingualNeural"  # TTS Voice to use (Default: "en-US-EmmaMultilingualNeural")
)
