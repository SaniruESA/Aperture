    ...
    while i < len(popups):
        ...
        if popup["position"] is not None:
            ...
            label = pyglet.text.Label(
                popup["text"],
                popup["position"][0] + text_padding,
                popup["position"][1] + text_padding,
                font_size=30,
                batch=batch,
                group=label_group,
            ...
            rect = pyglet.shapes.BorderedRectangle(
                popup["position"][0],
                popup["position"][1],
                label_size[0] + 2 * text_padding,
                label_size[1] + 2 * text_padding,
                batch=batch,
                group=rect_group,
...
popups: list[dict] = [
    {
        "text": "This program is using Aperture",
        "time": 0,
        "text-color": (0, 0, 0),
